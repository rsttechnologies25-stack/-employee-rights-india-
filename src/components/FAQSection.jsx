        ...
        <section className="mt-12" id="faq">
            ...
            <div className="space-y-3">
                {faqs.map((faq, idx) => (
                    <div
                        key={idx}
                        className={`bg-white rounded-xl border overflow-hidden transition-all duration-300 ${openIndex === idx ? 'border-primary/30 shadow-md' : 'border-gray-100 shadow-soft'}`}
                    >
                        <button
                            onClick={() => toggle(idx)}
                        ...
                        >
                            <div className="overflow-hidden">
                                <div className="px-5 pb-5 pl-[3.75rem] text-gray-600 leading-relaxed border-t border-gray-50 pt-4">
                                    {faq.answer}
                                </div>
                            </div>
                        </div>
