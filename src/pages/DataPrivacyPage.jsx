                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <ContentSection title="Monitoring Company Devices" icon={Laptop} variant="info">
                        <div className="space-y-4">
                            <p className="text-gray-700">The general legal rule is simple: <strong>If the company owns the device, they have the right to monitor it.</strong></p>
                            
                            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm mt-4">
                                <h4 className="font-bold text-gray-900 mb-3">What employers can legally track on a company laptop:</h4>
                    ...
                    <ContentSection title="Monitoring Personal Devices (BYOD)" icon={Smartphone} variant="warning">
                        <div className="space-y-4">
                            <p className="text-gray-700">If you use your personal phone or laptop for work (Bring Your Own Device), the employer's rights are strictly limited.</p>
                            
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                <div className="bg-white p-4 rounded-lg border border-warning/20">
                                    <h4 className="font-bold text-gray-900 text-sm">MDM Software</h4>
                                    <p className="text-sm text-gray-600 mt-1">If you install Mobile Device Management (MDM) software to access company email, the employer can enforce security (like a remote wipe of the work profile) but cannot legally read your personal texts or view your photos.</p>
                                </div>
                                <div className="bg-white p-4 rounded-lg border border-danger/20">
                                    <h4 className="font-bold text-gray-900 text-sm">Location Tracking</h4>
                                    <p className="text-sm text-gray-600 mt-1">Under the Information Technology Act, tracking the GPS location of a personal device without explicit, ongoing consent is a severe violation of privacy.</p>
                                </div>
                            </div>
                        </div>
                    </ContentSection>
