                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <ContentSection title="What is a PIP Legally?" icon={Target} variant="warning">
                        <div className="space-y-4">
                            <p className="text-gray-700">A Performance Improvement Plan (PIP) is an internal HR tool used to formally notify an employee that their work is not meeting company standards. Legally speaking:</p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div className="bg-white p-4 rounded-xl border border-warning/20 shadow-sm">
                                    ...
                                    <p className="text-sm text-gray-600">A PIP is <strong>not</strong> a termination notice. You are still an active employee with all standard rights, salary, and benefits during the PIP duration.</p>
                                </div>
                                <div className="bg-white p-4 rounded-xl border border-danger/20 shadow-sm">
                                    <h4 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                                        <FileSignature className="w-4 h-4 text-danger" /> The "Paper Trail"
                                    </h4>
                                    <p className="text-sm text-gray-600">In the corporate/IT sector, employers often use PIPs to create a legally defensible "paper trail" to justify firing you later for underperformance rather than illegal retrenchment.</p>
                                </div>
                            </div>
                        </div>
                    </ContentSection>
                    ...
                    <ContentSection title="Termination After a PIP" icon={AlertTriangle} variant="danger">
                        <div className="space-y-4">
                            <p className="text-gray-700">If you fail the PIP and the company decides to terminate your employment, they must still follow the law:</p>
