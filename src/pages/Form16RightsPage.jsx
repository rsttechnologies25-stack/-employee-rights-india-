                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <ContentSection title="Employer's Legal Obligation" icon={Building2} variant="info">
                        <div className="space-y-4">
                            <p className="text-gray-700">Under the Income Tax Act, Form 16 is a certificate of deduction of tax at source (TDS) issued on your salary. It is a vital document for filing your Income Tax Return (ITR).</p>
                            
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                <div className="bg-white p-5 rounded-lg border border-gray-100 shadow-sm">
                                    <h4 className="font-bold text-gray-900">Deadline for Issuance</h4>
                                    <p className="text-sm text-gray-600 mt-2">Your employer is legally mandated to issue Form 16 by <strong>June 15th</strong> of the financial year immediately following the financial year in which the tax was deducted.</p>
                                </div>
                                <div className="bg-white p-5 rounded-lg border border-gray-100 shadow-sm">
                                    <h4 className="font-bold text-gray-900">Penalty for Non-Compliance</h4>
                                    <p className="text-sm text-gray-600 mt-2">If your employer fails to issue Form 16, they are liable for a penalty of <strong>₹100 per day</strong> for every day the default continues, under Section 272A(2)(g).</p>
                                </div>
                            </div>
                        </div>
                    </ContentSection>
                    ...
                    <ContentSection title="What to do if TDS is deducted but NOT deposited?" icon={AlertCircle} variant="danger">
                        <div className="space-y-4">
                            <p className="text-gray-700">One of the most severe frauds an employer can commit is deducting tax from your salary but failing to deposit it with the Income Tax Department. You will know this has happened if the TDS shown on your payslips does not reflect in your <strong>Form 26AS</strong>.</p>
                            ...
                            <h4 className="font-bold text-gray-900 mt-6">Steps to Protect Yourself:</h4>
                    ...
                    <ContentSection title="Filing ITR without Form 16" icon={HelpCircle} variant="default">
                        <div className="space-y-4">
                            <p className="text-gray-700">If your employer has shut down, refuses to issue Form 16, or you simply lost it, you <strong>can</strong> still file your income tax returns legally.</p>
