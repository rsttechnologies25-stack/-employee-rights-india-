        ...
        <div className="py-12 px-4 bg-gray-50 dark:bg-gray-900">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-2xl">Know what you are signing. Understanding the legal validity of employment agreements and bonds.</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-950 rounded-2xl p-8 border border-gray-100 dark:border-gray-800 shadow-soft">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6 italic">A bond is usually only legally enforceable if it satisfies three conditions:</p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-6 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                            <span className="text-primary font-black text-2xl mb-2 block">01</span>
                            <h4 className="font-bold mb-2">Specific Training</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400">The company must have sent you for a specific training (not just 'on-the-job' training).</p>
                        </div>
                        <div className="p-6 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                            <span className="text-primary font-black text-2xl mb-2 block">02</span>
                            <h4 className="font-bold mb-2">Proof of Expense</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400">The employer must have proof of actual financial expenditure for that specific training.</p>
                        </div>
                        <div className="p-6 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                            <span className="text-primary font-black text-2xl mb-2 block">03</span>
                            <h4 className="font-bold mb-2">Reasonable Period</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400">The bond duration must be reasonable relative to the training cost (usually not exceeding 1-2 years).</p>
                        </div>
                    </div>
                </div>
            </div>
