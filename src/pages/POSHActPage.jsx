                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <ContentSection title="What Constitutes Harassment?" icon={AlertTriangle} variant="danger">
                        <div className="space-y-4">
                            <p className="text-gray-700 dark:text-gray-300">Under the POSH Act, 2013, sexual harassment includes any one or more of the following unwelcome acts or behavior (whether directly or by implication):</p>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                                {[
                                    ...
                                    <div key={idx} className="bg-white dark:bg-gray-950 p-3 rounded-lg border border-gray-100 dark:border-gray-800 flex gap-2 items-start shadow-sm">
                    ...
                    <ContentSection title="The Internal Complaints Committee (ICC)" icon={Users} variant="info">
                        <div className="space-y-4">
                            <p className="text-gray-700 dark:text-gray-300">Every organization with <strong>10 or more employees</strong> is legally required to constitute an Internal Complaints Committee (ICC). If your company does not have one, they are liable for a ₹50,000 fine and cancellation of their business license.</p>
                            <div className="bg-white dark:bg-gray-950 p-6 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
                                <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-4">Mandatory ICC Composition:</h3>
                    ...
                    <ContentSection title="Complaint & Inquiry Process" icon={Scale} variant="default">
                        <div className="space-y-6">
                            <div className="relative border-l-2 border-primary/30 pl-6 pb-6">
                                ...
                                <h4 className="font-bold text-gray-900 dark:text-gray-100">1. Filing the Complaint</h4>
                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Submit a written complaint to the ICC within 3 months of the incident. You can request assistance from the ICC if you cannot write it yourself.</p>
                            </div>
                            <div className="relative border-l-2 border-primary/30 pl-6 pb-6">
                                <div className="absolute w-4 h-4 bg-primary rounded-full -left-[9px] top-1" />
                                <h4 className="font-bold text-gray-900 dark:text-gray-100">2. Conciliation (Optional)</h4>
                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Before initiating an inquiry, the ICC may attempt to settle the matter through conciliation, BUT ONLY if you explicitly request it. No monetary settlement can be made the basis of conciliation.</p>
                            </div>
                            <div className="relative border-l-2 border-primary/30 pl-6 pb-6">
                                <div className="absolute w-4 h-4 bg-primary rounded-full -left-[9px] top-1" />
                                <h4 className="font-bold text-gray-900 dark:text-gray-100">3. Inquiry & Interim Relief</h4>
                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">The ICC must complete the inquiry within 90 days. During this time, you can request interim relief such as a transfer for yourself or the respondent, or up to 3 months of paid leave.</p>
                            </div>
                            <div className="relative border-l-2 border-transparent pl-6">
                                <div className="absolute w-4 h-4 bg-primary rounded-full -left-[9px] top-1" />
                                <h4 className="font-bold text-gray-900 dark:text-gray-100">4. Action & Report</h4>
                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">The ICC submits its report within 10 days of completion. If proven guilty, the employer must act upon the ICC's recommendations (termination, deduction of compensation from salary, written apology, etc.) within 60 days.</p>
                            </div>
                        </div>
                    </ContentSection>
